...
<div class="robot-container">
  <img src="https://cdn-icons-png.flaticon.com/512/4712/4712035.png" alt="Jesus I.A. Robot">
...
# -------------------- CABEÇALHO --------------------
st.markdown("# JJBOOK 📚🤖")
st.write("🔎 Digite seu tema ou palavra-chave abaixo para encontrar livros e artigos acadêmicos organizados:")

# -------------------- INPUTS --------------------
with st.form("search_form"):
    target = st.text_input("🎯 Tema ou Target Principal:")
...
if submitted and target:
    ...
    if not all_results:
        ...
        cols = st.columns(3)
        for idx, result in enumerate(all_results[:9]):
            bullets = [
            ...
            with cols[idx % 3]:
                ...
                st.image(result.get("image", "https://via.placeholder.com/150"), width=100)
                st.markdown("\n".join(bullets))
                st.markdown(f"</div>", unsafe_allow_html=True)

    st.markdown("---")
    st.markdown("Desenvolvido por Jesus I.A. 🤖")
